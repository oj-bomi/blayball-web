  ...
  return (
    <div className="h-screen lg:h-auto">
      ...
      <div className="absolute flex flex-col items-center w-full h-[80%] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-764">
        ...
        {/* 글씨 */}
        <div
          className={`${PretendardRegular.className} text-[#FF4400] bg-white border-solid border-[#707070] border leading-[3.5rem] lg:leading-[5.2vw] text-center w-[95%] lg:w-[39%] max-w-[764px]`}
        >
          <div className="text-[1.6rem] lg:text-[2.87vw] xl:text-[55px] border-solid border-[#707070] border-b">
            <p>
              HELLO.{" "}
          ...
          <div className="text-[1.2rem] lg:text-[2.08vw] xl:text-[40px]">
