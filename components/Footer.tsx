...
<div className="col text-center text-md-start bg-black py-[50px]">
   ...
   <p className="mb-0 text-small text-white py-[5px]">
     오제이 주식회사(OJ Inc.)<span className="middot">/</span>블레이볼(blayball)<span className="middot">/</span>CEO 오지완<span className="middot">/</span>CBO 강영모<span className="middot">/</span> Business Registration No141-81-49244
    </p>
   <p className="mb-0 text-small text-white py-[5px]">
